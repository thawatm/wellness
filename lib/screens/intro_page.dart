      ...
      body: IntroductionScreen(
        pages: [
          ...
          PageViewModel(
            ...
            body:
                "การปรับเปลี่ยนพฤติกรรมและวิถีชีวิตที่เหมาะสม โดยการปฏิบัติตามตัวชี้วัด 7 อย่าง ได้รับการพิสูจน์แล้วว่าสามารถช่วยลดความเสี่ยงในการเสียชีวิตก่อนวัยอันควรได้ถึงร้อยละ 91 โดยโปรแกรมของเราจะช่วยประเมินและให้คำแนะนำส่วนตัวรายสัปดาห์ รวมทั้งเก็บข้อมูลเพื่อใช้เฝ้าติดตามสุขภาพของท่านต่อไป",
